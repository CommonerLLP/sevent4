...
![Fixed DPL branches against the Delhi Metro network (OpenStreetMap: 246 stations and the line geometry). Branches more than 800 m from a station are marked in red. Half the fixed network is off the Metro grid.](figures/figD4_dpl_transit_siting.png){#fig-transit width=100%}
