...
Official public-functionary contacts are not private data for this project.
Phone numbers and email addresses for councillors, commissioners, public
officers, and public offices that come from official public rosters may be
displayed, attributed, and used in popups. In short: official contacts from
public rosters may be displayed.

OSM-derived contact fields need audit before they are treated as evidence.
OpenStreetMap service layers may carry phone, email, or mobile fields for
schools, clinics, businesses, or other non-official entities. Those fields can
remain in the open-data layer with OSM attribution, but they should not be used
as authoritative contact evidence unless the source, office status, and
currency are separately checked.
