...
@media(max-width:980px){.filterbar{top:54px;right:12px;grid-template-columns:1fr 1fr}.filterbar .fbtn2{min-width:0}.govpanel{top:auto;bottom:10px;left:12px;right:12px;width:auto;max-width:none;max-height:42vh}}@media(max-width:760px){.app{grid-template-columns:1fr;grid-template-rows:auto 1fr}.rail{max-height:34vh}.filterbar{top:10px;left:10px;right:10px;grid-template-columns:1fr 1fr}.filterbar .fsel,.filterbar .fbtn2{height:36px;font-size:11px;padding:8px}#map,.mapwrap{height:66vh}.govpanel{top:auto;bottom:10px;left:10px;right:10px;width:auto;max-width:none;max-height:38vh}}
"""
